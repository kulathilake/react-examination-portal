...
import {Row,Col,Affix,Button, Statistic, Tree, Divider, Spin } from 'antd';
    ...
    return(
        <Row gutter={[24,24]}>
            ...
            <Affix  offsetTop={10}>
                ...
                <Row>
                    <Statistic title="Time Remaining" value={timer ||"∞ hrs, ∞ mins, ∞ secs "}/>
                    <Button 
                ...
                <Row>
                    ...
                    showLine={true}
                    showIcon={true}
                    onSelect={(key)=>setCurrentQuestion(parseInt(key[0].split("-")[1]))}
